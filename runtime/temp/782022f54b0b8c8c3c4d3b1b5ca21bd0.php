<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/serve/ldx/public/../application/index/view/article/article.html";i:1543245796;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="titie">
                ...
                <div class="shop">
                    <div class="number">
                        ...
                        <input id="num" type="text" name="goods_num" value="0">
                ...
                <script>
                    $(function () {
                        var num=$('#num').val();
                        $('.num_lr').click(function () {
                            num++;
                            $('#num').val(num);
                        });
                        $('.num_lf').click(function () {
                            num--;
                            num=num<0?0:num;
                            $('#num').val(num);
                        });
