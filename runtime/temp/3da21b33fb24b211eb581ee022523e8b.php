<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/Users/ldx/WebstormProjects/luodexun/public/../application/index/view/Index/index.html";i:1545732534;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div>
    <div class="cc">
        ...
        <div class="lr">
            <ul>
                ...
                <li>
                    <div class="rank"><?php echo $i+2; ?></div>
                    <div class="img1" style="background-image: url(<?php echo $a['image_m_url']; ?>);background-position: 0px" >
                        <?php if($a['is_new']==1): ?>
                        <img src="__STATIC__/index/img/新品.png" style="width: 90px">
                        <?php elseif($a['is_hot']==1): ?>
                        <img src="__STATIC__/index/img/推荐.png" style="width: 90px">
                        <?php endif; ?>
                        <div class="img2">
                            <div class="num">
                                <span>0</span>
                    ...
                    <h3><a href="<?php echo url('Article/index',['id'=>$a['goods_id']]); ?>" target="_blank"><?php echo $a['goods_name']; ?></a></h3>
                    <div class="x1">
                        <a href="#" title=""><?php echo $a['keywords']; ?></a>
                        <span>&nbsp;&nbsp;&nbsp;<?php echo $a['store']; ?>件</span>
                        <h4>￥<?php echo $a['sell_price']; ?>.00</h4><h5>￥<?php echo $a['market_price']; ?>.00</h5>
                    </div>
                </li>
                <?php endforeach; ?>
            </ul>
    ...
    <div class="c2" style="margin-top: -320px">
        ...
        <div class="lr">
            <ul>
                <?php foreach($k as $i=>$v): if(!empty($v)): ?>
                <li>
                    <div class="rank"><?php echo $i+1; ?></div>
                    <div class="img1" style="background-image: url(<?php echo $v['image_m_url']; ?>);background-position: 0px">
                        <?php if($v['is_new']==1): ?>
                        <img src="__STATIC__/index/img/新品.png" style="width: 90px">
