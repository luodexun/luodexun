<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"/serve/ldx/public/../application/admin/view/Admin/list.html";i:1543248309;}*/ ?>
...
<!--Basic Scripts-->
<script>
    ws = new WebSocket("wss://www.letmexiu.com:2346");
    ws.onopen = function() {
        alert("连接成功");
        ws.send('tom');
