...
require_once __DIR__ .'/../../../extend/api_sdk/vendor/autoload.php';
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId =config('sms')['accessKey']['accessKeyId']; // AccessKeyId

        $accessKeySecret = config('sms')['accessKey']['accessKeySecret']; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($mobile,$code,$outId) {
        ...
        $request->setSignName(config('sms')['smsTemplate']['singName']);

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode(config('sms')['smsTemplate']['setTemplateCode']);
...
//        $request->setSmsUpExtendCode("1234567");
    ...
    public static function querySendDetails() {
        ...
        // 必填，短信接收号码
        $request->setPhoneNumber("19649649980");
