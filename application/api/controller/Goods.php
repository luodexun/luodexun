...
class Goods extends Base {
    public function index($params){
        ...
        $decrypted=openssl_decrypt(base64_decode('GTdDSZ5+ly40Dp2FQz41N1rrH+GbTaljjHxhqVFcn0HyulEa3dFCAs9rfV41hh5q'),"AES-128-CBC",'8NONwyJtHesysWpM',OPENSSL_ZERO_PADDING,'12345678a0123f56');
        dump($decrypted);exit();
        $condition = [
